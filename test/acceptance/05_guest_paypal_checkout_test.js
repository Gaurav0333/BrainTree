...
Scenario(
'05 Guest can place order using PayPal account on checkout', 
async ({I}) => {
	...
	I.wait(4)
	//pause()
	I.click("#dwfrm_billing > fieldset:nth-child(3) > div.form-nav.billing-nav.payment-information > ul > li:nth-child(2) > a") // click on 'PP tab'
	I.wait(3)
