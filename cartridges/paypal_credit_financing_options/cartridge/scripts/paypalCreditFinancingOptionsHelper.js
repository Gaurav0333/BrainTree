...
} = require('../scripts/financialApi');

var creditFinancialOptionsHelper = {};
var cachePaypalCreditFinancingOptions = require('dw/system/CacheMgr').getCache('paypalCreditFinancingOptions');
...
creditFinancialOptionsHelper.getAllOptions = function (cost, currencyCode, countryCode, creditType) {
    ...
    result = data.financing_options.reduce(function (acc, financingOption) {
