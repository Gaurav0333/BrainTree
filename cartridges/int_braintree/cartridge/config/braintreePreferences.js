...
var getPreference = function () {
    ...
    prefs.checkoutFromCartUrl = URLUtils.https('Braintree-CheckoutFromCart').toString();

    prefs.paymentMethods = require('../scripts/braintree/helpers/paymentHelper').getActivePaymentMethods();

    prefs.currencyCode = site.getDefaultCurrency();
    prefs.braintreeChannel = 'SFCC_BT_SFRA_20_2_2';
    prefs.userAgent = 'Braintree DW_Braintree 20.2.2';
